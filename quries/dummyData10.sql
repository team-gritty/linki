INSERT INTO user (
    ...
    user_pay_status, user_status, user_enter_day, user_role
      ...
      ('USR-0000000000000002', 'user02', 'pw0002', '김선민', '010-1111-0002', 'seonmink12@naver.com', 0, 1, '2023-02-15', 'ROLE_INFLUENCER'),
      ...
      ('USR-0000000000000006', 'user06', 'pw0006', '정난희', '010-1111-0006', 'user06@email.com', 1, 1, '2023-06-18', 'ROLE_ADVERTISER'),
