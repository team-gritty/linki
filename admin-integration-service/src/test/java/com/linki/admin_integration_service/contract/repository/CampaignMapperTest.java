...
public class CampaignMapperTest {
    ...
    public void getAllCampaigns() {
        List<CampaignDTO> campaignDTOList = campaignMapper.getCampaigns();
    ...
    public void searchCampaigns() {
        ...
        dto1.setKeyword("");
        List<CampaignDTO> result1 = campaignMapper.searchCampaign(dto1);
        ...
        dto2.setSearchType("");
        List<CampaignDTO> result2 = campaignMapper.searchCampaign(dto2);
        ...
        dto3.setKeyword("");
        dto3.setSearchType("");
        List<CampaignDTO> result3 = campaignMapper.searchCampaign(dto3);
        ...
        dto4.setKeyword("1");
        List<CampaignDTO> result4 = campaignMapper.searchCampaign(dto4);
        ...
        List<CampaignDTO> result5 = campaignMapper.searchCampaign(dto5);
        ...
        List<CampaignDTO> result6 = campaignMapper.searchCampaign(dto6);
        ...
        List<CampaignDTO> result7 = campaignMapper.searchCampaign(dto7);
        ...
        List<CampaignDTO> result8 = campaignMapper.searchCampaign(dto8);
