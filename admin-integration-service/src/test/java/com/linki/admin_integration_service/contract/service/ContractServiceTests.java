...
public class ContractServiceTests {
    ...
    @Test
    @DisplayName("계약 정보 가져오기 Service Test")
    ...
    @Test
    @DisplayName("계약 정보 검색 Service Test")
    public void searchContractsTest(){
        ...
        List<ContractDTO> contractDTOS1 = contractService.searchContract(contractSearchDTO1);
        ...
        List<ContractDTO> contractDTOS2 = contractService.searchContract(contractSearchDTO2);
        ...
        List<ContractDTO> contractDTOS3 = contractService.searchContract(contractSearchDTO3);
        ...
        List<ContractDTO> contractDTOS4 = contractService.searchContract(contractSearchDTO4);
        ...
        List<ContractDTO> contractDTOS5 = contractService.searchContract(contractSearchDTO5);
        ...
        List<ContractDTO> contractDTOS6 = contractService.searchContract(contractSearchDTO6);
