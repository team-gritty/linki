...
public class SettlementServiceTests {
    ...
    @Test
    @DisplayName("전체 정산 정보 가져오기 Service Test")
    public void getAllSettlements() {
        List<SettlementDTO> dtoList = settlementService.getAllSettlements();
        log.info(" 테스트 결과 : {}", dtoList.size());
    }

    @Test
    @DisplayName("정산 정보 검색 Service Test")
    public void searchSettlements() {
        // keyword = null / searchType = notNull
        SettlementSearchDTO dto = new SettlementSearchDTO();
        dto.setKeyword("");
        dto.setSearchType("");
        List<SettlementDTO> dtoList = settlementService.searchSettlement(dto);
        ...
        List<SettlementDTO> dtoList2 = settlementService.searchSettlement(dto2);
        ...
        List<SettlementDTO> dtoList3 = settlementService.searchSettlement(dto3);
        ...
        List<SettlementDTO> dtoList4 = settlementService.searchSettlement(dto4);
        ...
        List<SettlementDTO> dtoList5 = settlementService.searchSettlement(dto5);
        ...
        List<SettlementDTO> dtoList6 = settlementService.searchSettlement(dto6);
