...
public class InfluencerServiceTests {
    ...
    @Autowired
    private InfluencerUserService influencerUserService;

    @Test
    @DisplayName("인플루언서 회원 검색 Mapepr Test")
    public void getAllInfluencerUserTest(){
        List<InfluencerUserDTO> influencerUserDTOList = influencerUserService.getAllInfluencerUsers();
    ...
    public void searchInfluencerUserTest(){
        ...
        List<InfluencerUserDTO> influencerUserDTOList = influencerUserService.searchInfluencerUser(influencerUserSearchRequestDTO);
        ...
        List<InfluencerUserDTO> influencerUserDTOList2 = influencerUserService.searchInfluencerUser(influencerUserSearchRequestDTO2);
        ...
        List<InfluencerUserDTO> influencerUserDTOList3 = influencerUserService.searchInfluencerUser(influencerUserSearchRequestDTO3);
        ...
        List<InfluencerUserDTO> influencerUserDTOList4 = influencerUserService.searchInfluencerUser(influencerUserSearchRequestDTO4);
        ...
        List<InfluencerUserDTO> influencerUserDTOList5 = influencerUserService.searchInfluencerUser(influencerUserSearchRequestDTO5);
        ...
        List<InfluencerUserDTO> influencerUserDTOList6 = influencerUserService.searchInfluencerUser(influencerUserSearchRequestDTO6);
        ...
        List<InfluencerUserDTO> influencerUserDTOList7 = influencerUserService.searchInfluencerUser(influencerUserSearchRequestDTO7);
        ...
        List<InfluencerUserDTO> influencerUserDTOList8 = influencerUserService.searchInfluencerUser(influencerUserSearchRequestDTO8);
        ...
        List<InfluencerUserDTO> influencerUserDTOList9 = influencerUserService.searchInfluencerUser(influencerUserSearchRequestDTO9);
