...
public class SubscriberUserMapperTests {
    ...
    public void getAllSubscriberUsers() {
        List<SubscriberUserDTO> subscriberUserDTOS = subscriberUserMapper.getAllSubscriberUsers();
    ...
    public void searchSubscriberUser() {
        ...
        dto1.setSearchType("");
        dto1.setKeyword("");
        List<SubscriberUserDTO> result1 = subscriberUserMapper.searchSubscriberUser(dto1);
        ...
        dto2.setKeyword("");
        List<SubscriberUserDTO> result2 = subscriberUserMapper.searchSubscriberUser(dto2);
        ...
        List<SubscriberUserDTO> result3 = subscriberUserMapper.searchSubscriberUser(dto3);
        ...
        List<SubscriberUserDTO> result4 = subscriberUserMapper.searchSubscriberUser(dto4);
        ...
        List<SubscriberUserDTO> result5 = subscriberUserMapper.searchSubscriberUser(dto5);
        ...
        List<SubscriberUserDTO> result6 = subscriberUserMapper.searchSubscriberUser(dto6);
        ...
        List<SubscriberUserDTO> result7 = subscriberUserMapper.searchSubscriberUser(dto7);
