...
@Log4j2
public class AdvertiserUserMapperTests {

    @Autowired
    private AdvertiserUserMapper advertiserUserMapper;

    @Test
    @DisplayName("광고주 회원 가져오기")
    public void getAllAdvertiserUsers() {
        List<AdvertiserUserDTO> advertiserUserDTOS = advertiserUserMapper.getAllAdvertiserUsers();
    ...
    public void searchAdvertiserUsers() {
        ...
        List<AdvertiserUserDTO> advertiserUserDTOList1 = advertiserUserMapper.searchAdvertiserUser(advertiserSearchRequestDTO);
        ...
        List<AdvertiserUserDTO> advertiserUserDTOList2 = advertiserUserMapper.searchAdvertiserUser(advertiserSearchRequestDTO2);
        ...
        List<AdvertiserUserDTO> advertiserUserDTOList3 = advertiserUserMapper.searchAdvertiserUser(advertiserSearchRequestDTO3);
        ...
        List<AdvertiserUserDTO> advertiserUserDTOList4 = advertiserUserMapper.searchAdvertiserUser(advertiserSearchRequestDTO4);
        ...
        List<AdvertiserUserDTO> advertiserUserDTOList5 = advertiserUserMapper.searchAdvertiserUser(advertiserSearchRequestDTO5);
        ...
        List<AdvertiserUserDTO> advertiserUserDTOList6 = advertiserUserMapper.searchAdvertiserUser(advertiserSearchRequestDTO6);
        ...
        List<AdvertiserUserDTO> advertiserUserDTOList7 = advertiserUserMapper.searchAdvertiserUser(advertiserSearchRequestDTO7);
        ...
        List<AdvertiserUserDTO> advertiserUserDTOList8 = advertiserUserMapper.searchAdvertiserUser(advertiserSearchRequestDTO8);
        ...
        List<AdvertiserUserDTO> advertiserUserDTOList9 = advertiserUserMapper.searchAdvertiserUser(advertiserSearchRequestDTO9);
