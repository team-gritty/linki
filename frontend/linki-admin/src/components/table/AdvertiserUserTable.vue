...
const searchConfig = {
  options: [
    ...
    { value: 'businessNumber', label: '사업자번호', endpoint: '/v1/admin/api/advertiserUser/search' },
    { value: 'businessName', label: '사업자명', endpoint: '/v1/admin/api/advertiserUser/search' }
  ],
  placeholder: '검색어를 입력하세요',
  endpoint: '/v1/admin/api/advertiserUser'
}
